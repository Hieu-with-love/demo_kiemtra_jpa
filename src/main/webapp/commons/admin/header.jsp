...
<div class="iq-sidebar  sidebar-default ">
    <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
        <a href="index.html" class="header-logo">
            <img src="${URL}template/assets/images/logo.png" class="img-fluid rounded-normal light-logo" alt="logo"><h5 class="logo-title light-logo ml-3">POSDash</h5>
        </a>
                    ...
                    <ul id="product" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li class="">
                            <a href="${pageContext.request.contextPath}/admin/books">
                                <i class="las la-minus"></i><span>List Book</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="${pageContext.request.contextPath}/admin/books/add">
                                <i class="las la-minus"></i><span>Add Book</span>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            <div class="card border-none">
                <div class="card-body p-0">
                    <div class="sidebarbottom-content">
                        <div class="image"><img src="${URL}template/assets/images/layouts/side-bkg.png" class="img-fluid" alt="side-bkg"></div>
    ...
    <div class="iq-navbar-custom">
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                ...
                <a href="index.html" class="header-logo">
                    <img src="${URL}template/assets/images/logo.png" class="img-fluid rounded-normal" alt="logo">
                    ...
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
                        <li class="nav-item nav-icon dropdown">
                            <a href="#" class="search-toggle dropdown-toggle btn border add-btn"
                               ...
                               aria-expanded="false">
                                <img src="${URL}template/assets/images/small/flag-01.png" alt="img-flag"
                                ...
                                <div class="card shadow-none m-0">
                                    <div class="card-body p-3">
                                        <a class="iq-sub-card" href="#"><img
                                                src="${URL}template/assets/images/small/flag-02.png" alt="img-flag"
                                                class="img-fluid mr-2">French</a>
                                        <a class="iq-sub-card" href="#"><img
                                                src="${URL}template/assets/images/small/flag-03.png" alt="img-flag"
                                                class="img-fluid mr-2">Spanish</a>
                                        <a class="iq-sub-card" href="#"><img
                                                src="${URL}template/assets/images/small/flag-04.png" alt="img-flag"
                                                class="img-fluid mr-2">Italian</a>
                                        <a class="iq-sub-card" href="#"><img
                                                src="${URL}template/assets/images/small/flag-05.png" alt="img-flag"
                                                class="img-fluid mr-2">German</a>
                                        <a class="iq-sub-card" href="#"><img
                                                src="${URL}template/assets/images/small/flag-06.png" alt="img-flag"
                                        ...
                                        <div class="px-3 pt-0 pb-0 sub-card">
                                                ...
                                                <div class="media align-items-center cust-card py-3 border-bottom">
                                                    <div class="">
                                                        <img class="avatar-50 rounded-small"
                                                             src="${URL}template/assets/images/user/01.jpg" alt="01">
                                                    </div>
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="media align-items-center cust-card py-3 border-bottom">
                                                    <div class="">
                                                        <img class="avatar-50 rounded-small"
                                                             src="${URL}template/assets/images/user/02.jpg" alt="02">
                                                    </div>
                                                    <div class="media-body ml-3">
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="media align-items-center cust-card py-3">
                                                    <div class="">
                                                        <img class="avatar-50 rounded-small"
                                                             src="${URL}template/assets/images/user/03.jpg" alt="03">
                                                    </div>
                                                    <div class="media-body ml-3">
                                                        <div class="d-flex align-items-center justify-content-between">
                        ...
                        <li class="nav-item nav-icon dropdown caption-content">
                            <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton4"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="${URL}template/assets/images/user/1.png" class="img-fluid rounded" alt="user">
                            </a>
                            <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <div class="card shadow-none m-0">
                                    <div class="card-body p-0 text-center">
                                        <div class="media-body profile-detail text-center">
                                            <img src="${URL}template/assets/images/page-img/profile-bg.jpg" alt="profile-bg"
                                                 class="rounded-top img-fluid mb-4">
                                            <img src="${URL}template/assets/images/user/1.png" alt="profile-img"
                                        ...
                                        <div class="p-3">
                                            ...
                                            <div class="d-flex align-items-center justify-content-center mt-3">
                                                <a href="user-profile.html" class="btn border mr-2">Profile</a>
