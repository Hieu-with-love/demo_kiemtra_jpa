      ...
      <div class="table-responsive rounded mb-3">
        <table class="data-table table mb-0 tbl-server-info">
          ...
          <tr>
            ...
            <td>
              <div class="d-flex align-items-center">
                <img src="assets/images/product/02.jpg" class="img-fluid rounded avatar-50 mr-3" alt="image">
                <div>
                  Rain Umbrella
                  <p class="mb-0"><small>This is test Product</small></p>
                </div>
          ...
          <tr>
            ...
            <td>
              <div class="d-flex align-items-center">
                <img src="assets/images/product/03.jpg" class="img-fluid rounded avatar-50 mr-3" alt="image">
                <div>
                  Serum Bottle
                  <p class="mb-0"><small>This is test Product</small></p>
                </div>
          ...
          <tr>
            ...
            <td>
              <div class="d-flex align-items-center">
                <img src="assets/images/product/04.jpg" class="img-fluid rounded avatar-50 mr-3" alt="image">
                <div>
                  Coffee Beans
                  <p class="mb-0"><small>This is test Product</small></p>
                </div>
          ...
          <tr>
            ...
            <td>
              <div class="d-flex align-items-center">
                <img src="assets/images/product/05.jpg" class="img-fluid rounded avatar-50 mr-3" alt="image">
                <div>
                  Book Shelves
                  <p class="mb-0"><small>This is test Product</small></p>
                </div>
          ...
          <tr>
            ...
            <td>
              <div class="d-flex align-items-center">
                <img src="assets/images/product/06.jpg" class="img-fluid rounded avatar-50 mr-3" alt="image">
                <div>
                  Dinner Set
                  <p class="mb-0"><small>This is test Product</small></p>
                </div>
          ...
          <tr>
            ...
            <td>
              <div class="d-flex align-items-center">
                <img src="assets/images/product/07.jpg" class="img-fluid rounded avatar-50 mr-3" alt="image">
                <div>
                  Nike Shoes
                  <p class="mb-0"><small>This is test Product</small></p>
                </div>
          ...
          <tr>
            ...
            <td>
              <div class="d-flex align-items-center">
                <img src="assets/images/product/08.jpg" class="img-fluid rounded avatar-50 mr-3" alt="image">
                <div>
                  Computer Glasses
                  <p class="mb-0"><small>This is test Product</small></p>
                </div>
          ...
          <tr>
            ...
            <td>
              <div class="d-flex align-items-center">
                <img src="assets/images/product/09.jpg" class="img-fluid rounded avatar-50 mr-3" alt="image">
                <div>
                  Alloy Jewel Set
                  <p class="mb-0"><small>This is test Product</small></p>
                </div>
